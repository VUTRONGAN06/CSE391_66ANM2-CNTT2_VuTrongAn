...
**Mã sinh viên:** 2451271075
**Lớp:** 66ANM1
**Thời gian làm:** __60 phút  
**Hình thức:** Cá nhân  
...
JavaScript là ngôn ngữ lập trình dùng để tạo tương tác và xử lý hành vi trên trang web. Nó thường được dùng cùng với HTML và CSS để xây dựng website.
...
arr.push(4) chạy được vì có thể thay đổi phần tử của mảng.
arr = [5] lỗi vì biến const không thể gán lại giá trị mới.
...
== là toán tử so sánh lỏng, nó sẽ tự động ép kiểu dữ liệu trước khi so sánh.

=== là toán tử so sánh nghiêm ngặt, nó so sánh cả giá trị và kiểu dữ liệu, không ép
...
Khi một điều kiện trong chuỗi if ... else if ... else đúng thì các nhánh phía sau sẽ không được kiểm tra nữa.
Chương trình sẽ thực hiện khối lệnh của điều kiện đúng đó.
...
Parameter (tham số):
là biến được khai báo trong định nghĩa của hàm.
...
constructor là hàm đặc biệt trong class dùng để khởi tạo giá trị ban đầu cho object khi object được tạo ra.
...
Prototype là cơ chế trong JavaScript cho phép object kế thừa thuộc tính và phương thức từ object khác. Khi một object không có thuộc tính cần tìm, JavaScript sẽ tìm trong prototype của object đó.
...
Object.create(personPrototype) tạo một object mới và thiết lập personPrototype làm prototype của object đó.
